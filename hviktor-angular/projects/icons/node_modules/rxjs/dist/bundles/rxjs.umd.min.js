...
(function (g, y) {
  ...
  function Ca(b) {
    S.useDeprecatedSynchronousErrorHandling
      ? S.useDeprecatedSynchronousErrorHandling && U && ((U.errorThrown = !0), (U.error = b))
      : Jb(b);
  }
  function Wa(b, a) {
      ...
      a.subscribe(
        m(
          ...
          function (l) {
            f = !0;
            if (!b || b(l, h++, a))
              (d && c.error(new kd('Too many matching values')), (d = !0), (e = l));
          },
          function () {
  ...
  function Kd(b, a) {
    for (var c = 0, d = a.length; c < d; c++)
      for (
        var e = a[c], f = Object.getOwnPropertyNames(e.prototype), h = 0, g = f.length;
        h < g;
        h++
      ) {
        var k = f[h];
    ...
    return new r(function (a) {
              ...
              null ===
                (c =
                  null === document || void 0 === document
                    ? void 0
                    : document.cookie.match(new RegExp('(^|;\\s*)(' + t + ')\x3d([^;]*)'))) ||
              void 0 === c
                ? void 0
                : c.pop()) && void 0 !== d
            ? d
      ...
      h = function (c, b) {
        u.addEventListener(c, function () {
          var c,
            d = b();
          null === (c = null === r || void 0 === r ? void 0 : r.error) || void 0 === c
            ? void 0
            : c.call(r, d);
          a.error(d);
        });
      ...
      r &&
        [zb, Ab].forEach(function (a) {
          return u.upload.addEventListener(a, function (a) {
            var c;
            return null === (c = null === r || void 0 === r ? void 0 : r.next) || void 0 === c
              ? void 0
              : c.call(r, a);
          });
        });
      ...
      u.addEventListener(Nd, function (c) {
        var b,
          ...
          e = u.status;
        if (400 > e) {
          null === (b = null === r || void 0 === r ? void 0 : r.complete) || void 0 === b
            ? void 0
            : b.call(r);
          b = void 0;
          try {
          ...
          (null === (d = null === r || void 0 === r ? void 0 : r.error) || void 0 === d
            ? void 0
            : d.call(r, c),
            x(e));
      });
  ...
  var Ta = function (b, a) {
            ...
            try {
              for (var m = F(a), p = m.next(); !p.done; p = m.next()) {
                ...
                try {
                  ...
                  ((f = null !== f && void 0 !== f ? f : []),
                    B instanceof Sa ? (f = x(x([], w(f)), w(B.errors))) : f.push(B));
                }
              }
            } catch (B) {
              b = { error: B };
    ...
    na = (function (b) {
      ...
      a.prototype.unsubscribe = function () {
        this.closed ||
          ((this.isStopped = !0), b.prototype.unsubscribe.call(this), (this.destination = null));
      };
    ...
    N = {
      ...
      requestAnimationFrame: function () {
        ...
        a = N.delegate;
        return (
          (null === a || void 0 === a ? void 0 : a.requestAnimationFrame) || requestAnimationFrame
        ).apply(void 0, x([], w(b)));
      },
      cancelAnimationFrame: function () {
        ...
        a = N.delegate;
        return (
          (null === a || void 0 === a ? void 0 : a.cancelAnimationFrame) || cancelAnimationFrame
        ).apply(void 0, x([], w(b)));
      },
      delegate: void 0,
    },
      ...
      a.prototype.next = function (a) {
        ...
        Ba(function () {
          ...
          if (!b.isStopped) {
            ...
            try {
              for (var h = F(b.currentObservers), g = h.next(); !g.done; g = h.next())
                g.value.next(a);
            } catch (k) {
              c = { error: k };
            } finally {
    ...
    Db = (function (b) {
      ...
      a.prototype.next = function (a) {
        var b, c;
        null === (c = null === (b = this.destination) || void 0 === b ? void 0 : b.next) ||
        void 0 === c
          ? void 0
          : c.call(b, a);
      };
      a.prototype.error = function (a) {
        var b, c;
        null === (c = null === (b = this.destination) || void 0 === b ? void 0 : b.error) ||
        void 0 === c
          ? void 0
          : c.call(b, a);
      };
      a.prototype.complete = function () {
        var a, b;
        null === (b = null === (a = this.destination) || void 0 === a ? void 0 : a.complete) ||
        void 0 === b
          ? void 0
          : b.call(a);
      };
      a.prototype._subscribe = function (a) {
        var b, c;
        return null !==
          (c = null === (b = this.source) || void 0 === b ? void 0 : b.subscribe(a)) && void 0 !== c
          ? c
          : Pd;
      };
      return a;
    ...
    ma = {
      setImmediate: function () {
        for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
        a = ma.delegate;
        return ((null === a || void 0 === a ? void 0 : a.setImmediate) || Ve).apply(
          void 0,
          x([], w(b)),
        );
      },
    ...
    Ud = (function (b) {
      ...
      a.prototype.flush = function () {
        for (
          ...
          (f = a[0]) &&
          f.delay <= b &&
          !(a.shift(), (this.frame = f.delay), (e = f.execute(f.state, f.delay)));
        );
        if (e) {
