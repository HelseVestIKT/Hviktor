...
export const CardKortSomErEnLenkeExampleSource = `import { Component } from '@angular/core';

@Component({
  selector: 'app-card-kort-som-er-en-lenke-example',
  standalone: true,
  template: \`
    som ytterst element. Dette er nyttig når du ønsker at all tekst og innhold i Card blir lest opp av skjermlesere som én sammenhengende lenke."
         >
